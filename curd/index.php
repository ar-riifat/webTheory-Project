...
<body>
    ...
    <div class="container my-4">
        <header class="d-flex justify-content-between my-4">
            <h1>Hospital List</h1>
            <div>
                <a href="create.php" class="btn btn-primary">Add New Hospital</a>
            </div>
        </header>
        <?php
        session_start();
        ...
        while($data = mysqli_fetch_array($result)){
            ...
            <tr>
                ...
                <td><?php echo $data['findhosp']; ?></td>
                <td><?php echo $data['specialized']; ?></td>
                <td><?php echo $data['doctor']; ?></td>
                <td>
                    <a href="view.php?id=<?php echo $data['id']; ?>" class="btn btn-secondary">Read More</a>
